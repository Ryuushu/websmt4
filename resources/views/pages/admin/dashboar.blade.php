                ...
                <div
                    ...
                    <a href="index.html" class="lg:hidden">
                        ...
                        <img
                            ...
                            src="{{asset('assets/src/images/logo/logo-dark.svg')}}"
                            alt="Logo" />
                    </a>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            <span
                                                ...
                                                <img
                                                    src="{{asset('assets/src/images/user/user-02.jpg')}}"
                                                    alt="User"
                                    ...
                                    <li>
                                        <a
                                            ...
                                            <span
                                                class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                <img
                                                    src="{{asset('assets/src/images/user/user-03.jpg')}}"
                                                    alt="User"
                                                    class="overflow-hidden rounded-full" />
                                                <span
                                                    class="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            <span
                                                class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                <img
                                                    src="{{asset('assets/src/images/user/user-04.jpg')}}"
                                                    alt="User"
                                                    class="overflow-hidden rounded-full" />
                                                <span
                                                    class="absolute bottom-0 right-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            <span
                                                class="relative z-1 block h-10 w-full max-w-10 rounded-full">
                                                <img
                                                    src="{{asset('assets/src/images/user/user-05.jpg')}}"
                                                    alt="User"
                                                    class="overflow-hidden rounded-full" />
                                                <span
                    ...
                    <div
                        ...
                        <a
                            ...
                            <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                                <img src="{{asset('assets/src/images/user/user-01.jpg')}}" alt="User" />
                            </span>
                        ...
                        <div
                            ...
                            <div class="space-y-5">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="w-full max-w-8 items-center rounded-full">
                                            <img src="{{asset('assets/src/images/country/country-01.svg')}}" alt="usa" />
                                        </div>
                                        <div>
                                            <p
                                    ...
                                    <div class="flex w-full max-w-[140px] items-center gap-3">
                                        <div
                                            ...
                                            <div
                                                class="absolute left-0 top-0 flex h-full w-[79%] items-center justify-center rounded bg-brand-500 text-xs font-medium text-white"></div>
                                        </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="w-full max-w-8 items-center rounded-full">
                                            <img src="{{asset('assets/src/images/country/country-02.svg')}}" alt="france" />
                                        </div>
                                        <div>
                                            <p
                                                class="text-theme-sm font-semibold text-gray-800 dark:text-white/90">
                                    ...
                                    <div class="flex w-full max-w-[140px] items-center gap-3">
                                        <div
                                            class="relative block h-2 w-full max-w-[100px] rounded bg-gray-200 dark:bg-gray-800">
                                            <div
                                                class="absolute left-0 top-0 flex h-full w-[23%] items-center justify-center rounded bg-brand-500 text-xs font-medium text-white"></div>
                                        </div>
                                        <p class="text-theme-sm font-medium text-gray-800 dark:text-white/90">
                                            23%
                                        </p>
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex items-center gap-3">
                                                        <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                            <img src="{{asset('assets/src/images/product/product-01.jpg')}}" alt="Product" />
                                                        </div>
                                                        <div>
                                                            <p
                                        ...
                                        <tr>
                                            <td class="py-3">
                                                <div class="flex items-center">
                                                    <div class="flex items-center gap-3">
                                                        <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                            <img src="{{asset('assets/src/images/product/product-02.jpg')}}" alt="Product" />
                                                        </div>
                                                        <div>
                                                            <p
                                                                class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                        ...
                                        <tr>
                                            <td class="py-3">
                                                <div class="flex items-center">
                                                    <div class="flex items-center gap-3">
                                                        <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                            <img src="{{asset('assets/src/images/product/product-03.jpg')}}" alt="Product" />
                                                        </div>
                                                        <div>
                                                            <p
                                                                class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                        ...
                                        <tr>
                                            <td class="py-3">
                                                <div class="flex items-center">
                                                    <div class="flex items-center gap-3">
                                                        <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                            <img src="{{asset('assets/src/images/product/product-04.jpg')}}" alt="Product" />
                                                        </div>
                                                        <div>
                                                            <p
                                                                class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                        ...
                                        <tr>
                                            <td class="py-3">
                                                <div class="flex items-center">
                                                    <div class="flex items-center gap-3">
                                                        <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                                            <img src="{{asset('assets/src/images/product/product-05.jpg')}}" alt="Product" />
                                                        </div>
                                                        <div>
                                                            <p
                                                                class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
